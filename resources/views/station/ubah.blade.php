...
<div class="content-header row" style="margin-bottom:7.5px">
  <div class="content-header-left">
    <h4 class="content-header-title" style="margin-left: 10px;"><b>Edit Station</b></h4>
  </div>
</div>
...
<form method="post" action="{{ url('/station/ubah', $old_station->id) }}" role="form" enctype="multipart/form-data">
    {{csrf_field()}}
<div class="card row" style="margin-bottom: 10px">
    ...
    <div class="form-group col-md-11" style="width:97.5%; margin-left: 10px;">
        ...
        <input type="text" name="nama" class="form-control" id="nama" value="{{ $old_station->name }}" style="border-radius: 5px;" required>
    </div>
    </div>
